...
public class CreateBouquet extends JFrame {
	...
	public CreateBouquet(CustomerFrame ff) {
		...
		comboBox.setModel(new DefaultComboBoxModel(
				ItemOptions.FLOWER_TYPES.toArray(new String[ItemOptions.FLOWER_TYPES.size()])));
		panel.add(comboBox);
		...
		comboBox_1.setModel(new DefaultComboBoxModel(
				ItemOptions.FLOWER_COLORS.toArray(new String[ItemOptions.FLOWER_COLORS.size()])));
		...
		comboBox_2.setModel(new DefaultComboBoxModel(
				ItemOptions.BOUQUET_WRAP_COLOR.toArray(new String[ItemOptions.BOUQUET_WRAP_COLOR.size()])));
